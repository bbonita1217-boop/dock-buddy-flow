              ...
              <table className="w-full text-xs border-collapse">
                <thead>
                  <tr className="bg-muted/20">
                    <th className="text-left px-3 py-2 w-20 border-r sticky left-0 bg-muted/20">시간</th>
                    {dateList.map((d) => {
                      ...
                      {dateList.map((d) => {
                        ...
                        return (
                          <td key={d + t} className="border-r p-1.5 align-top">
                            ...
                            {booked.length === 0 && (
                              <div className="text-[10px] text-muted-foreground/40 px-1">빈 슬롯</div>
                            )}
                          </td>
                        );
                      })}
